...
#' @param harvest_rate A Logical value, if \code{TRUE} the harvest rate will be plotted, if \code{FALSE} the fishing mortality will be plotted.
...
#' @param ... Additional arguments passed to \code{plot_*} functions.
